...
import com.dlink.model.AiDIMModel;
...
public class DataBaseController {
     ...
     * 获取元数据的指定表的数据
     */
    @PostMapping("/aiDimModel")
    public Result aiDimModel(@RequestBody AiDIMModel aiDIMModel) {
        System.out.println(JSON.toString(aiDIMModel));

        return Result.succeed("调用成功");
    }
